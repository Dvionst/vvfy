		...
		<header style="margin-bottom:20px">
			...
			<div class="categori-tab">
				<ul class="main-tab" style="margin-top: 25px;">
					...
					<li style="color:#red"><a  href="<?php echo Yii::app()->createAbsoluteUrl("land/project"); ?>"> </a></li>
					<li style="color:#red"><a  href="<?php echo Yii::app()->createAbsoluteUrl("land/project"); ?>"> </a></li>
					<li style="color:#red"><a  href="<?php echo Yii::app()->createAbsoluteUrl("land/project"); ?>"> </a></li>
					<li style="color:#red"><a  href="<?php echo Yii::app()->createAbsoluteUrl("land/project"); ?>"> </a></li>
					<li style="color:#red"><a  href="<?php echo Yii::app()->createAbsoluteUrl("land/project"); ?>"> </a></li>
					...
					<div class="logout-user">
						<li style="" ><a style="color:black;font-size:20px" href="#">Hi  <?php echo Yii::app()->user->name; ?></a></li>
						<li style="" ><a href="<?php echo Yii::app()->createAbsoluteUrl("land/logout"); ?>">LOGOUT</a></li>
					</div>
				</ul>
			</div>
		</header>
