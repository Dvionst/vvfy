...
class HeadCategoriesController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('HeadCategories');
	...
	{
		$model=new HeadCategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['HeadCategories']))
			$model->attributes=$_GET['HeadCategories'];
	...
	{
		$model=HeadCategories::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='head-categories-form')
		{
