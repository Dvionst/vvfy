			...
			<div id="menu-instant-offer" class="cont-instant-offer">
				<div class="wrapper-calc">
					<div class="table-leftmenu">
						...
						<!--<div class="row" id="row-project-size" style="display:none"> if architecture 
							<div class="label"><span class="helper">project size</div>
							<div class="value">
								<input type="text">
							</div>
						</div>-->
...
<!-- 						<div class="row" id="row-areas" style="display:none">
							<div class="label"><span class="helper">Area 1</span></div>
							<div class="value">
								<select class="area-type">
									<option>Choose Area Type</option>
									<option>Living Room</option>
						...
						<div class="row" id="row-deadline" style="display:none"><!-- if architecture -->
							...
							<div class="value">
								<select style="width:29%!important;" placeholder="lol">
									<option>DATE</option>
									<?php
										for ($i=1; $i <= 31; $i++) { 
