...
$sql = "SELECT pv.id idviews ,ph.datetime, ph.project_id, 
pdm.name_file name_file,pdm.id AS id_comment,
SUBSTRING_INDEX(pdm.name_file,'.',-1) AS ext,
pdm.project_views_id
...
<div id="list-views" class="list-views owl-carousel"> <?php
foreach($views_timeline as $d): ?>     <div class="item"  >         <img
id_comment="<?php echo $d['id_comment'] ?>" id_views="<?php echo
$d['project_views_id'] ?>" file="<?php echo $d['name_file'] ?>" src="<?php
echo Yii::app()->request->baseUrl; ?>/img/comment/<?php echo $d[name_file] ?>"
alt="Owl Image">     </div>
