// var fs_body = jQuery('slide');
// // var fs_body = $('#slideshow');
...
// jQuery.fn.fs_gallery = function (fs_options) {
    ...
    // } else {
        // playpause = "fs_pause";
    // }
    // fs_body.append('<div style=""><div style="" class="fs_gallery_wrapper" ><ul class="' + fs_options.fit + ' fs_gallery_container ' + fs_options.fx + '"  /></div></div>');
...
// // $('.fs_gallery_container').css("height","700px")
	// // fs_body.append('<div style="width:100%;heigth:500px;background:red;z-index:99;float:right;position:fixed">gelooooo</div>');