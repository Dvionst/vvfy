...
<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/mobile400.css" type="text/css" media="only screen and (max-width: 399px) and (min-width: 100px)" />
...
<!-- <div class="wrapper-ct"> -->
	<a title="menu" href="javascript:void(0)"  class="control_toggle"> 
		<P class="lbl-menu">MENU</P>
	</a>
