...
class SocialShareWidget extends CWidget
{
	 ...
	 * @var array
	 */
	public $services = array(self::FACEBOOK, self::TWITTER, self::GOOGLE, self::LINKEDIN);
	...
	public $serviceUrls = array(
		...
		self::LINKEDIN  => 'https://www.linkedin.com/shareArticle?mini=true&url='
	);
	...
	public function run()
	{
		...
		$css="social-provider-icon-2";
		// if($style=1){
		// 	$css='social-provider-icon';
		// }elseif($style=2){
		// 	$css="social-provider-icon-2";
		// }
